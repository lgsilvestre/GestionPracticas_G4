...
class PracticaModel extends Model
{
    ...
    public function getDatosInscripcionAlumno($id){
        $queryPracticaAlumno = "SELECT empresa, supervisor, fecha_inicio, fecha_termino,rut_empresa, email_supervisor,telefono_supervisor,region,comuna,nombre_contacto,telefono_contacto FROM practica where practica.refAlumno = ".$id; //" and practica.numero = ".$numero;
        $query = $this->db->query($queryPracticaAlumno);
        $result = $query->getResult();
        return $result;
    }
    ...
    public function evaluarPractica($id_alumno, $nota){
        $queryPracticaAlumno = "UPDATE practica SET evaluacion_uni = '".$nota."', estado='Evaluada' WHERE practica.refAlumno = '".$id_alumno."' and practica.actica = 1"; 
        $this->db->query($queryPracticaAlumno)->getResult();
        $result = $this->db->affectedRows();
        return $result;
    }    
    ...
    public function getEstadoPracticaActiva($id){
        $queryPracticaAlumno = "SELECT etapa, estado,id_practica,numero FROM practica where practica.refAlumno = ".$id." and practica.estado != 'Evaluada' and practica.activa = 1" ;
        $query = $this->db->query($queryPracticaAlumno);
        $result = $query->getResult();
        return $result;
    }
